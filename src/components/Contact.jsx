...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "64236d16-ded8-46a3-b47f-9a9a4555aef3");
    ...
    return (
        ...
        className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden'>
            ...
            <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>
                Ready To Male A Move? Lets Build Your Future Together
            </p>
            ...
            <form onSubmit={onSubmit}  className='max-w-2xl mx-auto text-gray-600 pt-8' action="">
                <div className='flex flex-wrap'>
                    ...
                    <div className='w-full md:w-1/2 text-left md:pl-4'>
                        Your Email
                        <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="email" name="Emial" placeholder='Your Email' required />
                    </div>
                </div>
